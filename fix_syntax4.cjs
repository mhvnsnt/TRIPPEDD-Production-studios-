...
tm = tm.replace("this.createDef('tesseract', 'Tesseract OCR', 'Optical character recognition')", "this.createDef('tesseract', 'Tesseract OCR', 'Optical character recognition', 'CLI')");
