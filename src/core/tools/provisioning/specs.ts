...
sys.exit(0 if ok and fr is not None else 3)`,
  ...
  },
  {
    ...
    tier: 'INTERCHANGE',
    category: 'Editorial',
    license: 'GPL-3.0-or-later (MLT: LGPL-2.1)',
    sourceRepository: 'https://github.com/mltframework/mlt',
    ...
    health: {
      kind: 'media',
      // Builds a real one-clip project from the fixture and parses it back.
      args: (f) => ['-consumer', 'xml:/dev/null', f.video],
    },
  },
  {
    id: 'otio',
