import { Users, Film, LayoutDashboard, BookOpen, Wand2, Video, MonitorPlay, Settings, Search, FolderOpen, Wrench, PenTool, Image as ImageIcon, Mic, Clapperboard, Menu, ChevronLeft, Activity, Layers } from 'lucide-react';
