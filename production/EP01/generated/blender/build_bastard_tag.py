...
mat=bpy.data.materials.new('NearBlack'); mat.diffuse_color=(0.006,0.006,0.008,1); mat.metallic=0.1; mat.roughness=0.85
for o in [body,head,leg1,leg2,arm1,arm2,cliff]: o.data.materials.append(mat)

# Camera: low cinematic angle, 28 degrees below eye line.
bpy.ops.object.camera_add(location=(6.8,-11.5,2.0), rotation=(math.radians(78),0,math.radians(30)))
...
# Back/rim light so rain and silhouette read without turning into a poster.
...
rain_mat=bpy.data.materials.new('Rain'); rain_mat.diffuse_color=(0.2,0.3,0.45,1); rain_mat.metallic=0; rain_mat.roughness=0.25; rain_mat.use_nodes=True
bs=rain_mat.node_tree.nodes.get('Principled BSDF'); bs.inputs['Base Color'].default_value=(0.04,0.07,0.1,1); bs.inputs['Emission Color'].default_value=(0.04,0.08,0.14,1); bs.inputs['Emission Strength'].default_value=1.5
for i in range(180):
...
for f,e in [(1,0),(36,0),(42,12000),(46,0),(scene.frame_end,0)]: flash.data.energy=e; flash.keyframe_insert('energy',frame=f)
